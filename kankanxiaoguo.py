...
for ii in range(6,7):  ### 8,9   测试集
    data_test_path.append('E:\\datasets\\sk_output\\bbox_image\\subset%d' % ii)
    label_test_path.append('E:\\datasets\\sk_output\\bbox_mask\\\subset%d' % ii)
...
model = torch.load(r'E:\datasets\sk_output\model\best_model.pth')   ###在这里改
